...
SD="/scratch/o/oespinga/mirandab/Pheno_Cov_files/"
OUTDIR <- paste0(Sys.getenv("SCRATCH"),"/Pheno_Cov_files/")
...
pheno_dat <- merged_dat[, c("FID", "IID", "AURC")] 
...
print(read.table("/scratch/o/oespinga/mirandab/Pheno_Cov_files/covar.txt", header = TRUE, nrows = 5))

print(read.table("/scratch/o/oespinga/mirandab/Pheno_Cov_files/pheno.txt", header = TRUE, nrows = 5))
