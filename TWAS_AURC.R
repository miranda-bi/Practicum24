...
TWAS_v6 <- parallel::mclapply(1:22, function(chr){
  # chr=1
  ...
  # sample population with genetic information: 1194
...
TWAS_v6 <- as.data.frame(rbindlist(TWAS_v6))

save(TWAS_v6, file=paste0(OUTDIR,"TWAS_AURC_v6_PC1_",folder,".RData"))
